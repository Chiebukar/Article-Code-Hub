...
# let's  crop out the star in the flag
...
# # define the coordinates that maps out the yellow region
# startX, startY = 0, 143
# endX, endY = 640, 282
#
# # crop out the yellow region using coordinates
# yellow = image[startY:endY, startX:endX]
# cv2.imshow("yellow region", yellow)
# cv2.waitKey(0)

# define the coordinates that maps out the green region
startX, startY = 0, 285
endX, endY = 640, 425

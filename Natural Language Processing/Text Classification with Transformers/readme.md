In this article I share how to use transformer models for text classification using the approaches of Feature Extraction and Fine-tuning pre-trained models. 
